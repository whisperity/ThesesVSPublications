...
\subsection{Querying data}\label{query}
...
\FloatBarrier
\subsection{Reset \textsf{thesesvspublications} and create a different matrix}

\command{resetthesesvspublications}{\bslchar resetthesesvspublications}{%
Clears \textbf{all} internal data structures and definitions of the package, allowing the user to later typeset a different, independent matrix.
...
\immediate\openout\tempfile=reset-example.tex
    \immediate\write\tempfile{\bslchar resetthesesvspublications}
